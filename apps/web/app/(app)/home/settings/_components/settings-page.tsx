    ...
    switch (active) {
      ...
      case "roles":
        return (
          <SectionRoles
            workspace={workspace}
            onToggleCapability={commands.toggleCapability}
          />
        )
      case "sensitivity":
        return (
      ...
      case "billing":
        return <SectionBilling workspace={workspace} />
      case "audit":
        return <SectionAudit />
      case "danger":
        return <SectionDanger workspace={workspace} />
    }
  })()
  ...
  return (
    <div className="mx-auto w-full max-w-[1100px] px-6 pt-10 pb-24 md:px-14 md:pt-14">
      ...
      <div className="mt-7 grid items-start gap-x-14 gap-y-8 md:grid-cols-[200px_minmax(0,1fr)]">
        <SettingsRail
          sections={railView.sections}
          onSelect={setActive}
        />
        <div className="min-w-0 max-w-[760px]">{sectionContent}</div>
      </div>
    </div>
  )
}
