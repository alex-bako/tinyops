  ...
  return (
    <header className="mb-16">
      ...
      <Body size="lg" className="mt-5 max-w-[640px]">
        The building blocks of the TinyOps interface - colors, type, and the
        small components everything else composes from. Nothing here is a page.
        Everything here is a primitive.
      </Body>
    </header>
  )
}
    ...
    >
      <div className="flex flex-col gap-1">
        ...
        <Row label="16 / body-lg">
          <Body size="lg">Default copy for marketing and onboarding surfaces.</Body>
        </Row>
        <Row label="14 / body">
          <Body>
            Default body for dense product surfaces - timelines, tables, cards.
          </Body>
        </Row>
    ...
    >
      <div className="flex flex-col gap-8 max-w-[640px]">
        ...
        <Callout className="group/callout" tone="neutral">
          ...
          <CalloutSummary>
            Not enough history to personalize. Using the generic check-in.
          </CalloutSummary>
        </Callout>
      </div>
    </ShowcaseSection>
    ...
    >
      <div className="flex flex-wrap items-center gap-3">
        <Tooltip>
          ...
          <TooltipContent>Sourced from anna&apos;s Mar 8 email.</TooltipContent>
        </Tooltip>
