  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] flex flex-col gap-10">
        ...
        <Body
          size="lg"
          className="m-0 max-w-[46ch] text-[16px] leading-[1.55] text-slate-700"
        >
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className={cn(
          "absolute bottom-[22px] right-7 font-mono text-[10.5px] uppercase tracking-[0.2em] text-slate-300",
          "max-[960px]:hidden"
        )}
      >
